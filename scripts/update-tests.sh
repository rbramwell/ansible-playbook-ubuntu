...
rm -rf inventory/ubuntu.aio/hosts.aio
...
cat inventory/ubuntu.aio/hosts.aio | perl -p -e "s/^.*127.0.0.1/localhost.localdomain\tansible_connection=local/g" > tests/hosts
