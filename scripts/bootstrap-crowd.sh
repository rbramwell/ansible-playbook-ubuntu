...
perl -i -p -e "s/^#(apache2_vhosts_home):.*/\1: \"\/var\/lib\/crowd\"/g" $TMP_VARS
...
perl -i -p -e "s/^#(apache2_vhosts_id):.*/\1: \"crowd\"/g" $TMP_VARS
...
perl -i -p -e "s/^#(apache2_vhosts_server_name):.*/\1: \"crowd.example.com\"/g" $TMP_VARS
perl -i -p -e "s/^#(apache2_vhosts_uid):.*/\1: ~/g" $TMP_VARS
perl -i -p -e "s/^#(apache2_vhosts_user):.*/\1: \"crowd\"/g" $TMP_VARS
...
perl -i -p -e "s/^#(crowd_gid):.*/\1: \"{{ apache2_vhosts_gid }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_hash_salt):.*/\1: \"{{ apache2_vhosts_hash_salt }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_home):.*/\1: \"{{ apache2_vhosts_home }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_pass):.*/\1: \"{{ apache2_vhosts_pass }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_proxy_name):.*/\1: \"{{ apache2_vhosts_server_name }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_scheme):.*/\1: \"http\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_server_port):.*/\1: \"8020\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_uid):.*/\1: \"{{ apache2_vhosts_uid }}\"/g" $TMP_VARS
perl -i -p -e "s/^#(crowd_user):.*/\1: \"{{ apache2_vhosts_user }}\"/g" $TMP_VARS
